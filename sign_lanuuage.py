...
mp_hand = mp.soultions.hands
hands = mp_hands.Hands()
mp_draw = mp.soultions.drawing_utils
...
while True:
    ...
    if results.multi_hand_landmarks:
        for hand_landmark in resluts>multi_hand_landmark
        #accessing the landmarks by their position
            ...
            if all(finger_fold_status):
                ...
                if lm_list[thumb_tip].y > lm_list[thumb_tip-1].y > lm_list[thumb_tip-2].y:
                    ...
                    mp_hands.HANDS_CONNECTIONS, mp_drae.DrawingSpec(0,0,255),2,2),
                    mp_drae.DrawingSpec((0,255,0),4,2)
